      ...
      <div className="main_menu">
        <div className="main_menu_list">
          <div>
            ...
            <Link to="/following" style={{ textDecoration: "none", color:"black" }}>팔로잉</Link>
          </div>
          <div>
          <img src={'img/travel50.png'} alt="logo" id=""/>
            <Link to="/travel" style={{ textDecoration: "none" ,color:"black"}}>여행</Link>
          </div>
          <div>
          <img src={'img/event64.png'} alt="logo" id=""/>
            <Link to="/event"  style={{ textDecoration: "none", color:"black" }}>이벤트</Link>
          </div>
          <div>
          <img src={'img/qna.png'} alt="logo" id=""/>
            <Link to="/qa" style={{ textDecoration: "none", color:"black" }}>문의</Link>
          </div>
        </div>
      </div>
