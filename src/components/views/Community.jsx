  ...
  return (
    ...
    <div className='container'>
        <div className='board_btn'>
            <button style={{background: "#32D2C9"}}><Link to="/following" style={{ textDecoration: "none", color: "black"}}>팔로잉</Link></button>
            ...
            <button><Link to="/qa" style={{ textDecoration: "none",color: "black"}}>Q&A</Link></button>
        </div>

    <div className=' container mt-3'>
        <div>
        <Dropdown className='filter'>
                <Dropdown.Toggle className='filter-list'  id="dropdownMenuLink" aria-expanded="false" style={{backgroundColor:"#F1F1F1", color:"black"}} >
                    필터
                </Dropdown.Toggle>
